export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      clandes: {
        toggle: 'Clandes Exclusive',
        toggleDesc: 'Route this account through clandes only. Token refresh will be managed by clandes; sub2api will not refresh it.',
      },
    ...
    clandes: {
      ...
      description: 'View and manage the connection to the clandes proxy server',
      ...
      syncDisabledHint: 'Sync is available only when connected',
      notEnabled: 'Clandes integration is currently disabled. Enable it in config.yaml under the clandes section.',
      loadError: 'Failed to load Clandes status',
      configTitle: 'Integration Settings',
      configDesc: 'Saved directly to the config file. The server restarts to apply changes.',
      cfgEnabled: 'Enable Clandes integration',
      cfgAddr: 'RPC Address',
      cfgAuthToken: 'Auth Token',
      cfgAuthTokenSet: '(currently set)',
      cfgAuthTokenKeep: 'Leave empty to keep current token',
      cfgReconnectInterval: 'Reconnect Interval',
      cfgSeconds: 'seconds',
      cfgTokenShow: 'Show',
      cfgTokenHide: 'Hide',
      cfgTokenClear: 'Clear token',
      cfgRestartWarning: 'Saving rewrites the clandes section of config.yaml and restarts the server. Make sure sub2api runs under a supervisor (Docker restart policy, systemd, etc.) that will bring it back up.',
      cfgRestartConfirm: 'Save and restart the server now?',
      cfgSave: 'Save & Restart',
      cfgRestarting: 'Restarting…',
      cfgSavedRestarting: 'Config saved. Restarting…',
      cfgSaveFailed: 'Failed to save config',
    },
  },
