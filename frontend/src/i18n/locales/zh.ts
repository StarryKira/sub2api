export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      clandes: {
        toggle: 'Clandes 专用',
        toggleDesc: '此账号仅通过 clandes 代理转发。Token 刷新由 clandes 管理，sub2api 不会刷新此账号。',
      },
    ...
    clandes: {
      title: 'Clandes 集成',
      description: '查看和管理与 clandes 代理服务器的连接状态',
      status: '连接状态',
      integration: '集成',
      enabled: '已启用',
      disabled: '未启用',
      ...
      syncSuccess: '账号同步成功',
      syncFailed: '账号同步失败',
      syncDisabledHint: '仅在已连接时可同步',
      notEnabled: 'Clandes 集成当前未启用。请在 config.yaml 的 clandes 配置段中开启。',
      loadError: '获取 Clandes 状态失败',
      configTitle: '集成配置',
      configDesc: '直接写入配置文件，保存后服务会重启以使其生效。',
      cfgEnabled: '启用 Clandes 集成',
      cfgAddr: 'RPC 地址',
      cfgAuthToken: '认证 Token',
      cfgAuthTokenSet: '（已配置）',
      cfgAuthTokenKeep: '留空则保留当前 token',
      cfgReconnectInterval: '重连间隔',
      cfgSeconds: '秒',
      cfgTokenShow: '显示',
      cfgTokenHide: '隐藏',
      cfgTokenClear: '清除 token',
      cfgRestartWarning: '保存会重写 config.yaml 中的 clandes 段并重启服务。请确保 sub2api 运行在能自动拉起的进程管理器下（Docker restart 策略、systemd 等）。',
      cfgRestartConfirm: '确认保存并立即重启服务？',
      cfgSave: '保存并重启',
      cfgRestarting: '重启中…',
      cfgSavedRestarting: '配置已保存，服务正在重启…',
      cfgSaveFailed: '配置保存失败',
    },
  },
