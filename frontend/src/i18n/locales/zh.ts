export default {
  ...
  admin: {
    ...
    clandes: {
      ...
      accountName: '名称',
      accountType: '类型',
      noAccounts: '暂无 clandes 账号，点击添加开始使用。',
      createSuccess: '账号已创建并注册到 clandes',
      createFailed: '创建账号失败',
      deleteSuccess: '账号已删除',
      deleteFailed: '删除账号失败',
      login: '登录',
      oauthHint: '通过 OAuth 登录 Claude 账号。点击获取链接后，复制到指纹浏览器打开。',
      startOAuth: '获取 OAuth 链接',
      oauthUrl: 'OAuth 链接',
      oauthUrlHint: '复制此链接到指纹浏览器打开：',
      copied: '已复制',
